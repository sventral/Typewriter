...
export function serializeDocumentStateBase(state, { getActiveFontName } = {}) {
  ...
  return {
    ...
    distractionFreeModeEnabled: state.distractionFreeModeEnabled === true,
    distractionFreeHideBackgroundEnabled: state.distractionFreeHideBackgroundEnabled === true,
    distractionFreeAutoDarkPageEnabled: state.distractionFreeAutoDarkPageEnabled === true,
    distractionFreeAlwaysDarkPageEnabled: state.distractionFreeAlwaysDarkPageEnabled === true,
...
export function deserializeDocumentState(data, context) {
  ...
  Object.assign(state, {
    ...
    distractionFreeModeEnabled: data.distractionFreeModeEnabled === true,
    distractionFreeHideBackgroundEnabled: data.distractionFreeHideBackgroundEnabled === true,
    distractionFreeAutoDarkPageEnabled: data.distractionFreeAutoDarkPageEnabled === true,
    distractionFreeAlwaysDarkPageEnabled: data.distractionFreeAlwaysDarkPageEnabled === true,
    ...
    realTypewriterStopVolume: normalizedTypewriter.stopVolume,
