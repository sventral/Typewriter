const DOM_ID_GROUPS = {
  ...
  typography: {
    ...
    glyphJitterOptions: 'glyphJitterOptions',
    glyphBaselineOffsetToggle: 'glyphBaselineOffsetToggle',
    glyphBaselineOffsetOptions: 'glyphBaselineOffsetOptions',
    glyphBaselineOffsetAboveChars: 'glyphBaselineOffsetAboveChars',
    glyphBaselineOffsetAboveMin: 'glyphBaselineOffsetAboveMin',
    glyphBaselineOffsetAboveMax: 'glyphBaselineOffsetAboveMax',
    glyphBaselineOffsetBelowChars: 'glyphBaselineOffsetBelowChars',
    glyphBaselineOffsetBelowMin: 'glyphBaselineOffsetBelowMin',
    glyphBaselineOffsetBelowMax: 'glyphBaselineOffsetBelowMax',
    lineSlantOptions: 'lineSlantOptions',
  ...
  typewriter: {
    typewriterBellToggle: 'typewriterBellToggle',
    typewriterBellSoundRow: 'typewriterBellSoundRow',
    typewriterBellSelect: 'typewriterBellSelect',
    typewriterBellPreview: 'typewriterBellPreview',
    typewriterBellVolumeRow: 'typewriterBellVolumeRow',
    typewriterBellVolume: 'typewriterBellVolume',
    typewriterBellVolumeValue: 'typewriterBellVolumeValue',
    typewriterBellLeadRow: 'typewriterBellLeadRow',
    typewriterBellLead: 'typewriterBellLead',
    typewriterStopSoundRow: 'typewriterStopSoundRow',
    ...
    typewriterStopVolumeRow: 'typewriterStopVolumeRow',
    typewriterStopVolume: 'typewriterStopVolume',
    typewriterStopVolumeValue: 'typewriterStopVolumeValue',
